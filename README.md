...
The attribute version is documented in [AttributeVersion.md](AttributesVersion.md).
...
There is an [additional proposal](AttributesVersion.md) that uses Attributes for annotating code with the extra information required for generics.
